/* =========================================================
   ...
   Usuarios: Matheus movio, Alan Marques, Joao Victor, Kauã, Gabriel B., Gabriel Kirschner
   Gerado em: 04/09/2026, 14:09:02
   ========================================================= */
var COFRE = {
  "v": 1,
  "iter": 310000,
  "cfg": {
    "iv": "NbAvcjufS10oQM67",
    "ct": ""
  },
  "usuarios": [
    {
      "login": "Matheus movio",
      "nome": "matheus movio",
      "salt": "o9ySWmH1qBDBGP32xsaq3A==",
      "env": {
        "iv": "jEY+u/h+jdPhxTtK",
    ...
    },
    {
      ...
      "nome": "Gabriel Kirschner",
      "salt": "T3g3L3sCc9WYxnDFEQLnaw==",
      "env": {
        "iv": "Ay1dgyHikIgugwRT",
